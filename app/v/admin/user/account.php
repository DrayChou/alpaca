...
<form method="POST" >
    <table class="table-add table" cellspacing=0 >
        <tr>
            <th>email</th>
            <td>
                <input type="text" name="email" readonly="TRUE" value="<?= isset($val['email']) ? $val['email'] : '' ?>" >
            </td>
            <td>
        ...
        <tr>
            <th>用户名</th>
            <td>
                <input type="text" name="username" readonly="TRUE" value="<?= isset($val['username']) ? $val['username'] : '' ?>" >
            </td>
            <td>
