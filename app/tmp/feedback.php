    ...
    <form id="purchase-form" class="purchase-form" method="POST" action="<?= BASE ?>freeform/index/留言板/">
        <div class="basic">
            ...
            <div class="tr fd-clr">
                ...
                <div class="value">
                    <input type="text" maxlength="32" data-name="contactName" class="text shadow" value="" name="联系人">
                </div>
            </div>
            <div class="tr fd-clr">
                <div class="key">
                ...
                <div class="value">
                    <input type="text" maxlength="30" data-name="telephone" class="text shadow" value="" name="联系电话">
                </div>
            </div>
            <input type="hidden" id="recommend-input" value="false" name="_fm.p._0.en">
        </div>
