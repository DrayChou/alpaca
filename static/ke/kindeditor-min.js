...
(function (A, o) {
    ...
    function S(a, b, c, d, e) {
        var c = c || "", d = j(d, !1), e = j(e, "\t"), g = "xx-small,x-small,small,medium,large,x-large,xx-large".split(","), a = a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function (a, b, c, d) {
    ...
    function Ma(a, b, c) {
        ...
        var h = a.doc, f = [], k = a.cloneRange().down(), n = -1, r = -1, p = -1, m = -1, l = a.commonAncestor(), j = h.createDocumentFragment();
    ...
    function Ya(a, b) {
        var c = document.getElementsByTagName("head")[0] || (O ? document.body : document.documentElement), d = document.createElement("script");
        c.appendChild(d);
        d.src = a;
        d.charset = "utf-8";
        ...
        f(a.edit.doc).contextmenu(function (b) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    if (d.length > 0) {
                        b.preventDefault();
                        var g = f(a.edit.iframe).pos(), h = Wa({x: g.x + b.clientX, y: g.y + b.clientY, width: c, css: {visibility: "hidden"}, shadowMode: a.shadowMode});
                        m(d, function () {
                            this.title &&
                            h.addItem(this)
                        });
    ...
    function Jb(a, b) {
        ...
        if (j(b.loadStyleMode, f.options.loadStyleMode)) {
            var d = j(b.themeType, f.options.themeType);
    ...
    if (!A.KindEditor) {
        ...
        var Da = "4.1.7 (2013-04-21)", q = navigator.userAgent.toLowerCase(),
            l = q.indexOf("msie") > -1 && q.indexOf("opera") == -1, ea = q.indexOf("gecko") > -1 && q.indexOf("khtml") == -1, W = q.indexOf("applewebkit") > -1, La = q.indexOf("opera") > -1, bc = q.indexOf("mobile") > -1, cc = /ipad|iphone|ipod/.test(q), O = document.compatMode != "CSS1Compat", z = (q = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(q)) ? q[1] : "0", Ca = (new Date).getTime(), Q = Math.round, f = {DEBUG: !1, VERSION: Da, IE: l, GECKO: ea, WEBKIT: W, OPERA: La, V: z, TIME: Ca, each: m, isArray: Y, isFunction: bb, inArray: N, inString: ua, trim: B, addUnit: s, removeUnit: t, escape: C,
                unescape: fa, toCamel: ga, toHex: va, toMap: u, toArray: Fa, undef: j, invalidUrl: function (a) {
                    return!a || /[<>"]/.test(a)
                }, addParam: function (a, b) {
                    return a.indexOf("?") >= 0 ? a + "&" + b : a + "?" + b
                }, extend: E, json: cb}, jb = u("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"), kb = u("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
            ib = u("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"), Lb = u("b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u"), dc = u("img,table,input,textarea,button"), Ha = u("pre,style,script"), Ea = u("html,head,body,td,tr,table,ol,ul,li");
        u("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr");
        var Sb = u("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"), Mb = u("input,button,textarea,select");
        f.basePath = function () {
            for (var a =
        ...
        E(L, {init: function (a) {
            ...
            var b = this.startContainer, c = this.startOffset, d = this.endContainer, e = this.endOffset, g, f, i, k = 1;
        ...
        E(na, {init: function (a) {
            ...
            var a = j(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer, e = c.startOffset, g = T(d), h = this.win, i, k = !1;
        ...
        E(R, {init: function (a) {
            ...
            if (this._alignEl) {
                var g = f(this._alignEl), h = g.pos(), c = Q(g[0].clientWidth / 2 - c / 2), d = Q(g[0].clientHeight / 2 - d / 2);
                x = c < 0 ? h.x : h.x + c;
                y = d < 0 ? h.y : h.y + d
        ...
        E(pa, R, {init: function (a) {
            ...
            var d = j(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, i = location.host.replace(/:\d+/,
                "") !== document.domain, k = "document.open();" + (i ? 'document.domain="' + document.domain + '";' : "") + "document.close();", k = l ? ' src="javascript:void(function(){' + encodeURIComponent(k) + '}())"' : "";
        ...
        E(qa, R, {init: function (a) {
            ...
            if (a.title === "-")this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                var b = f('<div class="ke-menu-item" unselectable="on"></div>'),
                    c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = s(a.height), g = j(a.iconClass, "");
                this.div.append(b);
        ...
        f.colorpicker = Bb;
        E(Xa, {init: function (a) {
            var b = f(a.button), c = a.fieldName ||
                "file", d = a.url || "", e = b.val(), g = a.extraParams || {}, h = b[0].className || "", i = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
        ...
        E(sa, R, {init: function (a) {
            var b = j(a.shadowMode, !0);
            a.z = a.z || 811213;
            a.shadowMode = !1;
            a.autoScroll = j(a.autoScroll, !0);
            sa.parent.init.call(this, a);
            var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, g = a.yesBtn, h = a.noBtn, i = a.closeBtn, k = j(a.showMask, !0);
            ...
            this.mask = null;
            if (k)d = G(this.doc), this.mask = Ua({x: 0, y: 0, z: this.z - 1, cls: "ke-dialog-mask", width: Math.max(d.scrollWidth, d.clientWidth), height: Math.max(d.scrollHeight, d.clientHeight)});
        ...
        ta.prototype = {lang: function (a) {
            ...
            } else b._fullscreenExecuted && (f(document.body).css({height: "", overflow: ""}), f(document.body.parentNode).css("overflow", "")), b._scrollPos && A.scrollTo(b._scrollPos.x, b._scrollPos.y);
            var j = [];
            ...
            var h = b.toolbar = Ab({src: h, html: j.join(""), noDisableItems: b.noDisableItems, click: function (a, c) {
                a.stop();
                if (b.menu) {
                    var d = b.menu.name;
                    b.hideMenu();
                ...
                b.clickToolbar(c)
            }}), m = t(e) - h.div.height(), p = b.edit = yb({height: m > 0 && t(e) > b.minHeight ? m : b.minHeight,
                src: i, srcElement: b.srcElement, designMode: b.designMode, themesPath: b.themesPath, bodyClass: b.bodyClass, cssPath: b.cssPath, cssData: b.cssData, beforeGetHtml: function (a) {
                    a = b.beforeGetHtml(a);
            ...
            c ? (b._fullscreenResizeHandler = function () {
                ...
                b._scrollPos = ba()
            }), b.resizeType > 0 ? Sa({moveEl: g, clickEl: k, moveFn: function (a, c, d, e, g, f) {
                e += f;
                b.resize(null, e)
            }}) : k.first().css("visibility", "hidden"), b.resizeType === 2 ? Sa({moveEl: g, clickEl: k.last(), moveFn: function (a, c, d, e, g, f) {
                d += g;
                e += f;
                b.resize(d, e)
            ...
            a.closeBtn = j(a.closeBtn, {name: b.lang("close"), click: function () {
                b.hideDialog();
                l && b.cmd && b.cmd.select()
            }});
            a.noBtn = j(a.noBtn, {name: b.lang(a.yesBtn ? "no" : "close"), click: function () {
                b.hideDialog();
                l && b.cmd && b.cmd.select()
            }});
        ...
        Eb("core", function (a) {
            ...
            b.clickToolbar("formatblock", function () {
                ...
                m(a, function (a, e) {
                    ...
                    f.addItem({title: '<span style="' + j + '" unselectable="on">' + e + "</span>", height: c[a] + 12, checked: d === a || d === e, click: function () {
                ...
                a(d.body).bind("paste",
                    function (o) {
                        if (b.pasteType === 0)o.stop(); else if (!m) {
                            ...
                            j = a('<div class="' + n + '"></div>', d).css({position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: a(i.start).pos().y + "px", "white-space": "nowrap"});
                            a(d.body).append(j);
                            if (l) {
                                var q = f.range.get(!0);
