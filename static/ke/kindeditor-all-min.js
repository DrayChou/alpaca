...
(function (b, d) {
    ...
    function e(a, c) {
        for (var f = 0, b = c.length; f < b; f++)if (a === c[f])return f;
        return-1
    }

    function h(a, c) {
        if (g(a))for (var f = 0, b = a.length; f < b; f++) {
            if (c.call(a[f], f, a[f]) === !1)break
        } else for (f in a)if (a.hasOwnProperty(f) && c.call(a[f], f, a[f]) === !1)break
    }
    ...
    function z(a, c) {
        ...
        h(b, function (a, c) {
            if (u = /^(\d+)\.\.(\d+)$/.exec(c))for (var b = parseInt(u[1], 10); b <= parseInt(u[2], 10); b++)f[b.toString()] = !0; else f[c] = !0
        });
        return f
    }
    ...
    function H(a, c, f) {
        a.addEventListener ? a.addEventListener(c, f, db) : a.attachEvent && a.attachEvent("on" + c, f)
    }

    function v(a, c, f) {
        a.removeEventListener ? a.removeEventListener(c, f, db) : a.detachEvent && a.detachEvent("on" + c, f)
    }
    ...
    function N(a, c, f) {
        if (c && c.indexOf(",") >= 0)h(c.split(","), function () {
            ...
            if (b)if (c === d)b in L && (h(L[b],
                function (c, f) {
                    c != "el" && f.length > 0 && v(a, c, f[0])
                }), delete L[b], U(a)); else if (L[b]) {
                var u = L[b][c];
                if (u && u.length > 0) {
                    f === d ? (v(a, c, u[0]), delete L[b][c]) : (h(u, function (a, c) {
                        a > 0 && c === f && u.splice(a, 1)
                    }), u.length == 1 && (v(a, c, u[0]), delete L[b][c]));
                    var k = 0;
                    h(L[b], function () {
                        k++
                    });
    ...
    function V(a, c, f) {
        ...
        F(a, "keydown", function (b) {
            b.ctrlKey && b.which == c && !b.shiftKey && !b.altKey && (f.call(a), b.stop())
        })
    }

    function Q(a) {
        for (var c = {}, f = /\s*([\w\-]+)\s*:([^;]*)(;|$)/g, b; b = f.exec(a);) {
    ...
    function G(a) {
        for (var c = {}, f = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g, b; b = f.exec(a);) {
    ...
    function M(a, c, f, b) {
        function u(a) {
            for (var a = a.split("/"), c = [], f = 0, b = a.length; f < b; f++) {
                var d = a[f];
        ...
        function k(c, f) {
            ...
            } else if (i = /^(.*)\//.exec(c))return k(i[1], ++f)
        }
        ...
        if (b === d)var B = location.pathname.match(/^(\/.*)\//), b = B ? B[1] : "";
        var i;
        if (i = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (i[1] !== f)return a
        } else if (/^\w+:/.test(a))return a;
        /^\//.test(a) ?
            a = f + u(a.substr(1)) : /^\w+:\/\//.test(a) || (a = f + u(b + "/" + a));
        c === "relative" ? a = k(f + b, 0).substr(2) : c === "absolute" && a.substr(0, f.length) === f && (a = a.substr(f.length));
        return a
    }

    function J(a, c, f, b, d) {
        var f = f || "", b = r(b, !1), d = r(d, "\t"), k = "xx-small,x-small,small,medium,large,x-large,xx-large".split(","), a = a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function (a, c, f, b) {
        ...
        c && (h(c, function (a, c) {
            for (var f = a.split(","), b = 0, d = f.length; b < d; b++)B[f[b]] = z(c)
        }), B.script || (a = a.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/ig, "")), B.style || (a = a.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/ig, "")));
        var i = [], a = a.replace(/([ \t\n\r]*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>([ \t\n\r]*)/g, function (a, g, j, n, o, s, l) {
            var g = g || "", j = j || "", m = n.toLowerCase(), q = o || "", n = s ? " " + s : "", l = l || "";
            if (c && !B[m])return"";
            n === "" && fb[m] && (n = " /");
            gb[m] && (g && (g = " "), l && (l = " "));
            Ja[m] && (j ? l = "\n" : g = "\n");
            b && m == "br" && (l = "\n");
            if (hb[m] && !Ja[m])if (b) {
                j && i.length > 0 && i[i.length - 1] === m ? i.pop() : i.push(m);
                l = g = "\n";
                o = 0;
                for (s = j ? i.length : i.length - 1; o < s; o++)g += d, j || (l += d);
                n ? i.pop() : j || (l += d)
            } else g = l = "";
            if (q !== "") {
                var t = G(a);
                if (m === "font") {
                    var p = {}, w = "";
                    h(t, function (a, c) {
                        if (a === "color")p.color = c, delete t[a];
                        a === "size" && (p["font-size"] =
                ...
                h(t, function (a, b) {
                    ...
                    (c && a !== "style" && !B[m]["*"] && !B[m][a] || m === "body" && a === "contenteditable" || /^kindeditor_\d+$/.test(a)) && delete t[a];
                    if (a === "style" && b !== "") {
                        var d = Q(b);
                        h(d, function (a) {
                            c && !B[m].style && !B[m]["." + a] && delete d[a]
                        });
                        var K =
                            "";
                        h(d, function (a, c) {
                ...
                q = "";
                h(t, function (a, c) {
                    a === "style" && c === "" || (c = c.replace(/"/g, "&quot;"), q += " " + a + '="' + c + '"')
                })
            }
            m === "font" && (m = "span");
            return g + "<" + j + m + q + n + ">" + l
        }), a = a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function (a, c, f, b) {
    ...
    function ib(a, c) {
        var f = c.width, b = c.height, d = c.type || T(c.src), k = Ka(c), i = "";
        f > 0 && (i += "width:" + f + "px;");
        b > 0 && (i += "height:" + b + "px;");
        f = /realaudio/i.test(d) ? "ke-rm" : /flash/i.test(d) ? "ke-flash" : "ke-media";
        f = '<img class="' + f + '" src="' + a + '" ';
        i !== "" && (f += 'style="' + i + '" ');
    ...
    function Da(a, c) {
        ...
        function d(a, c, f) {
            var u = [];
            (a = (f.ownerDocument || f).getElementById(a.replace(/\\/g, ""))) && b(c, a.nodeName) && Ba(f, a) && u.push(a);
            return u
        }
        ...
        function k(a, c, f) {
            ...
            if (f.getElementsByClassName) {
                ...
                k = 0;
                for (i = d.length; k < i; k++)B = d[k], b(c, B.nodeName) && u.push(B)
            } else if (d.querySelectorAll) {
                d = d.querySelectorAll((f.nodeName !== "#document" ? f.nodeName + " " : "") + c + "." + a);
                k = 0;
                for (i = d.length; k < i; k++)B = d[k], Ba(f, B) && u.push(B)
            } else {
                d = f.getElementsByTagName(c);
                a = " " + a + " ";
                k = 0;
                for (i = d.length; k < i; k++)if (B = d[k], B.nodeType == 1)(c = B.className) && (" " + c + " ").indexOf(a) > -1 && u.push(B)
            }
            return u
        }

        function i(a, c, b, d) {
            for (var K = [], b = d.getElementsByTagName(b), u = 0, k = b.length; u < k; u++)d = b[u], d.nodeType == 1 && (c === null ? Ca(d, a) !== null && K.push(d) : c === f(Ca(d, a)) && K.push(d));
            return K
        }

        function g(a, c) {
            var f = [], e, P = (e = /^((?:\\.|[^.#\s\[<>])+)/.exec(a)) ? e[1] : "*";
            if (e = /#((?:[\w\-]|\\.)+)$/.exec(a))f = d(e[1], P, c); else if (e = /\.((?:[\w\-]|\\.)+)$/.exec(a))f = k(e[1], P, c); else if (e = /\[((?:[\w\-]|\\.)+)\]/.exec(a))f =
                i(e[1].toLowerCase(), null, P, c); else if (e = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                f = e[1].toLowerCase();
                e = e[2];
                if (f === "id")P = d(e, P, c); else if (f === "class")P = k(e, P, c); else if (f === "name") {
                    f = [];
                    e = (c.ownerDocument || c).getElementsByName(e.replace(/\\/g, ""));
                    for (var h, j = 0, o = e.length; j < o; j++)h = e[j], b(P, h.nodeName) && Ba(c, h) && h.getAttributeNode("name") && f.push(h);
                    P = f
                } else P = i(f, e, P, c);
                f = P
            } else {
                ...
                h = 0;
                for (j = P.length; h < j; h++)e = P[h], e.nodeType == 1 && f.push(e)
            }
            return f
        }
        ...
        for (var c = c || document, j = [], o, m = /((?:\\.|[^\s>])+|[\s>])/g; o = m.exec(a);)o[1] !== " " && j.push(o[1]);
        o = [];
        if (j.length == 1)return g(j[0], c);
        var m = !1, l, s, q, t, w, p, r, N, F, v;
        p = 0;
        for (lenth = j.length; p < lenth; p++)if (l = j[p], l === ">")m = !0; else {
            if (p > 0) {
                s = [];
                r = 0;
                for (F = o.length; r < F; r++) {
                    ...
                    q = g(l, t);
                    N = 0;
                    for (v = q.length; N < v; N++)w = q[N], m ? t === w.parentNode && s.push(w) : s.push(w)
                }
                o = s
            } else o = g(l, c);
            if (o.length ===
    ...
    function Mb(a, c) {
        var f = ha(a), b = p(c), d = "";
        f.getComputedStyle ? (f = f.getComputedStyle(a, null), d = f[b] || f.getPropertyValue(c) || a.style[b]) : a.currentStyle && (d = a.currentStyle[b] || a.style[b]);
        return d
    }
    ...
    function ma(a) {
        var a = a || document, c;
        C || Na ? (c = X(a).scrollLeft, a = X(a).scrollTop) : (c = ha(a).scrollX, a = ha(a).scrollY);
        return{x: c,
            y: a}
    }
    ...
    function Oa(a, c, f) {
        function b(d, K, u) {
            ...
            c && (i = d.cloneNode(!0), i = K > 0 ? i.splitText(K) : i, u < k && i.splitText(u - K));
            if (f) {
                var B = d;
        ...
        function k(d, u) {
            for (var m = d.firstChild, l; m;) {
                ...
                if (n >= 0)return!1;
                l = m.nextSibling;
                if (h > 0)if (m.nodeType == 1)if (j >= 0 && o <= 0)c && u.appendChild(m.cloneNode(!0)), f && e.push(m); else {
                    var s;
                    c && (s = m.cloneNode(!1), u.appendChild(s));
                    if (k(m, s) === !1)return!1
                } else if (m.nodeType == 3 && (m = m == g.startContainer ? b(m, g.startOffset, m.nodeValue.length) :
                    m == g.endContainer ? b(m, 0, g.endOffset) : b(m, 0, m.nodeValue.length), c))try {
                    u.appendChild(m)
                } catch (q) {
                }
                m = l
        ...
        var i = a.doc, e = [], g = a.cloneRange().down(), h = -1, j = -1, o = -1, n = -1, m = a.commonAncestor(), l = i.createDocumentFragment();
        if (m.nodeType == 3)return m = b(m, a.startOffset, a.endOffset), c && l.appendChild(m), d(), c ? l : a;
        k(m, l);
        f && a.up().collapse(!0);
    ...
    function kb(a, c) {
        ...
        for (var j = 0, o = k.length; j < o; j++) {
            ...
            if (g === 0)return{node: n.parentNode, offset: j};
            if (n.nodeType == 1) {
                ...
                l && i(l).remove()
            } else n.nodeType == 3 && (h.moveStart("character", n.nodeValue.length), e += n.nodeValue.length);
            g < 0 && (B = n)
        }
        if (g < 0 && B.nodeType == 1)return{node: d, offset: i(d.lastChild).index() + 1};
        ...
        e -= h.text.replace(/\r\n|\n|\r/g, "").length;
        if (g > 0 && B.nodeType ==
            3)for (f = B.previousSibling; f && f.nodeType == 3;)e -= f.nodeValue.length, f = f.previousSibling;
        return{node: B, offset: e}
    }

    function lb(a, c) {
        var f = a.ownerDocument || a, b = f.body.createTextRange();
        if (f == a)return b.collapse(!0), b;
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (k.nodeType == 1) {
                var B = i(k), e;
                B.isControl() && (e = f.createElement("span"), d ? B.before(e) : B.after(e), k = e);
                ta(b,
                    k);
                b.collapse(d);
                e && i(e).remove();
    ...
    function mb(a) {
        ...
        var f;
        if (C) {
            if (a.item)return f = ga(a.item(0)), f = new Z(f), f.selectNode(a.item(0)), f;
    ...
    function ob(a) {
        ...
        h(a, function (a, d) {
            f = a.split(",");
            for (var i =
                0, e = f.length; i < e; i++)b = f[i], c[b] = d
        });
        return c
    }
    ...
    function qb(a, c, f) {
        ...
        if (a.type ===
            1 && (c = ob(c), c[f])) {
            for (var f = c[f].split(","), c = !1, b = 0, d = f.length; b < d; b++) {
                var k = f[b];
                if (k === "*") {
                    c = !0;
                    break
    ...
    function Ua(a) {
        var c = a.moveEl, f = a.moveFn, b = a.clickEl || c, u = a.beforeDrag, k = [document];
        ...
        b.mousedown(function (a) {
            function d(a) {
                ...
                var c = i(ga(a.target)), k = ca((c.data("pos-x") ||
                    0) + a.pageX - s), a = ca((c.data("pos-y") || 0) + a.pageY - q);
            ...
            function g(a) {
                a.preventDefault();
                i(k).unbind("mousemove", d).unbind("mouseup", g).unbind("selectstart", e);
    ...
    function $a(a, c) {
        var f = document.getElementsByTagName("head")[0] || (aa ? document.body : document.documentElement), b = document.createElement("script");
        f.appendChild(b);
        b.src = a;
        b.charset = "utf-8";
        b.onload = b.onreadystatechange = function () {
            if (!this.readyState || this.readyState === "loaded")c && c(), b.onload = b.onreadystatechange = null, f.removeChild(b)
        }
    }
    ...
    function ab(a) {
        for (var c =
            document.getElementsByTagName("head")[0] || (aa ? document.body : document.documentElement), f = document.createElement("link"), b = xb(M(a, "absolute")), d = i('link[rel="stylesheet"]', c), k = 0, e = d.length; k < e; k++)if (xb(M(d[k].href, "absolute")) === b)return;
        c.appendChild(f);
        f.href = a;
        f.rel = "stylesheet"
    }
    ...
    function Ab(a, c) {
        ...
        if (typeof a === "string") {
            if (!$[c])return"no language";
            var f = a.length - 1;
            if (a.substr(f) === ".")return $[c][a.substr(0, f)];
            f = zb(a);
            return $[c][f.ns][f.key]
        }
        h(a, function (a, f) {
    ...
    function Fa(a, c) {
        if (!a.collapsed) {
            var a = a.cloneRange().up(), f = a.startContainer, b = a.startOffset;
            if (ja || a.isControl())if ((f = i(f.childNodes[b])) && f.name == "img" && c(f))return f
        }
    }
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    for (h(a._contextmenus, function () {
                        if (this.title == "-")b.push(this); else if (this.cond && this.cond() && (b.push(this), this.width && this.width > f))f = this.width
                    ...
                    if (b.length > 0) {
                        c.preventDefault();
                        var k = i(a.edit.iframe).pos(), e = Ya({x: k.x + c.clientX, y: k.y + c.clientY, width: f, css: {visibility: "hidden"}, shadowMode: a.shadowMode});
                        h(b, function () {
                            this.title &&
                            e.addItem(this)
                        });
                        var k = X(e.doc), g = e.div.height();
                        c.clientY + g >= k.clientHeight - 100 && e.pos(e.x, o(e.y) - g);
        ...
        if (!(C && b !== "br") && (!pa || !(O < 3 && b !== "p")) && !(Na && O < 9)) {
            ...
            i(f).keydown(function (i) {
                if (!(i.which !=
                    ...
                    c.cmd.selection();
                    var e = a(c.cmd.range);
                    e == "marquee" || e == "select" || (b === "br" && !d[e] ? (i.preventDefault(), c.insertHtml("<br />" + (C && O < 9 ? "" : "\u200b"))) : k[e] || ba(f, "formatblock", "<p>"))
                }
            });
            i(f).keyup(function (d) {
                if (!(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) && b != "br")if (pa) {
                    var d = c.cmd.commonAncestor("p"), u = c.cmd.commonAncestor("a");
                    u && u.text() == "" && (u.remove(!0), c.cmd.range.selectNodeContents(d[0]).collapse(!0), c.cmd.select())
                } else if (c.cmd.selection(), d = a(c.cmd.range),
                    !(d == "marquee" || d == "select"))if (k[d] || ba(f, "formatblock", "<p>"), d = c.cmd.commonAncestor("div")) {
                    for (var u = i("<p></p>"), e = d[0].firstChild; e;) {
                        var g = e.nextSibling;
                        u.append(e);
                        e = g
                    }
    ...
    function Rb() {
        ...
        i(c).keydown(function (f) {
            if (f.which == 9)if (f.preventDefault(), a.afterTab)a.afterTab.call(a, f); else {
                var f = a.cmd, b = f.range;
                b.shrink();
                b.collapsed && b.startContainer.nodeType == 1 && (b.insertNode(i("@&nbsp;", c)[0]), f.select());
                a.insertHtml("&nbsp;&nbsp;&nbsp;&nbsp;")
            }
        })
    }
    ...
    function Cb(a, c) {
        ...
        f.designMode ? (d = this.cmd.range, k = d.createBookmark(!0), k.html = b.innerHTML) : k = {html: b.innerHTML};
        Bb(c, k);
        var e = a.pop();
        ka(k.html) === ka(e.html) && a.length > 0 && (e = a.pop());
        f.designMode ? (f.html(e.html), e.start && (d.moveToBookmark(e), this.select())) : i(b).html(ka(e.html));
        return this
    }
    ...
    function Aa(a) {
        ...
        if (!f.width)f.width = b[0].style.width || b.width();
        if (!f.height)f.height = b[0].style.height || b.height();
        c("width", r(f.width, f.minWidth));
        c("height", r(f.height, f.minHeight));
        c("width", j(f.width));
        c("height", j(f.height));
        if (Tb && (!Ub || O < 534))f.designMode = !1;
        f.srcElement = b;
        f.initContent = "";
        f.plugin = {};
        f.isCreated = !1;
    ...
    function Db(a, c) {
        ...
        if ((b = i(a)) && b.length !==
            ...
            var d = new Aa(c);
            _instances.push(d);
            if ($[d.langType])return f(d);
            $a(d.langPath + d.langType + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ga : Ha), function () {
                f(d)
            });
            return d
        }
    ...
    function Eb(a, c) {
        i(a).each(function (a, b) {
            i.each(_instances, function (a, f) {
                if (f && f.srcElement[0] == b)return c.call(f, a, f), !1
            })
        })
    }
    ...
    if (!b.KindEditor) {
        ...
        i.basePath = function () {
            for (var a =
                document.getElementsByTagName("script"), c, f = 0, b = a.length; f < b; f++)if (c = a[f].src || "", /kindeditor[\w\-\.]*\.js/.test(c))return c.substring(0, c.lastIndexOf("/") + 1);
            return""
        }();
        ...
        A(E, {init: function (a, c) {
            ...
            if (!f.target)f.target = f.srcElement || b;
            ...
            if (f.pageX == null && f.clientX != null) {
                ...
                f.pageX = f.clientX + (i && i.scrollLeft || b && b.scrollLeft || 0) - (i && i.clientLeft || b && b.clientLeft || 0);
                f.pageY = f.clientY + (i && i.scrollTop || b && b.scrollTop || 0) - (i && i.clientTop || b && b.clientTop || 0)
            }
            if (!f.which && (f.charCode || f.charCode ===
                0 ? f.charCode : f.keyCode))f.which = f.charCode || f.keyCode;
            if (!f.metaKey && f.ctrlKey)f.metaKey = f.ctrlKey;
            if (!f.which && f.button !== d)f.which = f.button & 1 ? 1 : f.button & 2 ? 3 : f.button & 4 ? 2 : 0;
            switch (f.which) {
                case 186:
                    f.which = 59;
                    break;
        ...
        i.ready = function (a) {
            ...
            var i = !1;
            if (document.addEventListener)F(document, "DOMContentLoaded", c); else if (document.attachEvent) {
        ...
        i.clearMsWord = W;
        i.tmpl = function (a, c) {
            var f = new Function("obj", "var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('" + a.replace(/[\r\t\n]/g,
        ...
        i.queryAll = Da;
        A(R, {init: function (a) {
            for (var a = g(a) ? a : [a], c = 0, f = 0, b = a.length; f < b; f++)a[f] && (this[f] = a[f].constructor === R ? a[f][0] : a[f],
                c++);
            this.length = c;
            this.doc = ga(this[0]);
            this.name = Ma(this[0]);
            ...
            var f = this;
            if (a === d)return G(f.outer());
            if (typeof a === "object")return h(a, function (a, c) {
                f.attr(a, c)
            }), f;
            if (c === d)return c = f.length < 1 ? null : Ca(f[0], a), c === null ? "" : c;
            f.each(function () {
                La(this, a, c)
            });
            return f
            ...
            this.each(function () {
                var c = a;
                C && O < 8 && c.toLowerCase() == "class" && (c = "className");
                La(this, c, "");
            ...
            data: function (a, c) {
                ...
                if (a)if (a.getBoundingClientRect)a = a.getBoundingClientRect(), f = ma(this.doc), c = a.left + f.x, f = a.top + f.y; else for (; a;)c += a.offsetLeft, f += a.offsetTop, a = a.offsetParent;
            ...
            if (!(a === d || a === null)) {
                if (typeof a === "string") {
                    ...
                    if (a.length !== e || /<.+>/.test(a)) {
                        var e = (c ? c.ownerDocument || c : document).createElement("div"), u = [];
        ...
        A(Z, {init: function (a) {
            ...
            for (var c = a(this.startContainer),
                     b = a(this.endContainer), d = 0, i = c.length, k = b.length, e, g; ++d;)if (e = c[i - d], g = b[k - d], !e || !g || e !== g)break;
            return c[i - d + 1]
            ...
            if (C) {
                ...
                if (b !== 0)return b;
                var k, g, h, j;
                if (a === ra || a === sa)k = this.startContainer, h = this.startOffset;
                if (a === qa || a === na)k = this.endContainer, h = this.endOffset;
                if (a === ra || a === qa)g = c.startContainer, j = c.startOffset;
                if (a === na || a === sa)g = c.endContainer, j = c.endOffset;
                if (k === g)return k = h - j, k > 0 ? 1 : k < 0 ? -1 : 0;
                for (b = g; b && b.parentNode !== k;)b = b.parentNode;
                if (b)return i(b).index() >= h ? -1 : 1;
                for (b = k; b && b.parentNode !== g;)b = b.parentNode;
                if (b)return i(b).index() >= j ? 1 : -1;
                if ((b = i(g).next()) && b.contains(k))return 1;
                if ((b = i(k).next()) && b.contains(g))return-1
            ...
            var c = this.startContainer, b = this.startOffset, d = this.endContainer, i = this.endOffset, k, e, g, h = 1;
            if (a.nodeName.toLowerCase() === "#document-fragment")k = a.firstChild, e = a.lastChild, h = a.childNodes.length;
            c.nodeType == 1 ? (g = c.childNodes[b]) ?
                (c.insertBefore(a, g), c === d && (i += h)) : c.appendChild(a) : c.nodeType == 3 && (b === 0 ? (c.parentNode.insertBefore(a, c), c.parentNode === d && (i += h)) : b >= c.nodeValue.length ? c.nextSibling ? c.parentNode.insertBefore(a, c.nextSibling) : c.parentNode.appendChild(a) : (g = b > 0 ? c.splitText(b) : c, c.parentNode.insertBefore(a, g), c === d && (d = g, i -= b)));
            k ? this.setStartBefore(k).setEndAfter(e) : this.selectNode(a);
            if (this.compareBoundaryPoints(na, this.cloneRange().setEnd(d, i)) >= 1)return this;
            ...
            c.setEndPoint("StartToStart", lb(a.startContainer, a.startOffset));
            ...
            function a(a, b, d) {
                if (a.nodeType == 1 && (a = i(a).children(), a.length !== 0)) {
                    ...
                    b > 0 && (k = a.eq(b - 1));
                    b < a.length && (e = a.eq(b));
                    if (k && k.type == 3)g = k[0], h = g.nodeValue.length;
            ...
            function c(c, d, k) {
                c = i(c);
                if (!(c.type == 3 || Ia[c.name] || !a && c.isBlock()))if (d === 0) {
                    for (; !c.prev();) {
                        d = c.parent();
                        if (!d || Ia[d.name] || !a && d.isBlock())break;
                        c = d
                    }
            ...
            if (!this.collapsed)c = b.cloneNode(!0), c.id = "__kindeditor_bookmark_end_" + Ib++ + "__";
        ...
        A(ua, {init: function (a) {
            ...
            b = C && (!d || !d.item && d.parentElement().ownerDocument !== c) ? null : d;
            this.sel = Qa(c);
            if (b)return this.range = Pa(b), i(this.range.startContainer).name == "html" && this.range.selectNodeContents(c.body).collapse(!1),
                this;
            a && this.range.selectNodeContents(c.body).collapse(!1);
            return this
        }, select: function (a) {
            var a = r(a, !0), c = this.sel, b = this.range.cloneRange().shrink(), d = b.startContainer, e = b.startOffset, k = ga(d), g = this.win, h, j = !1;
            if (a && d.nodeType == 1 && b.collapsed) {
                ...
                if (ja && (a = d.childNodes, i(d).isInline() || e > 0 && i(a[e - 1]).isInline() || a[e] && i(a[e]).isInline()))b.insertNode(k.createTextNode("\u200b")),
                    j = !0
            }
            if (C)try {
                h = b.get(!0), h.select()
            } catch (o) {
            } else j && b.collapse(!1), h = b.get(!0), c.removeAllRanges(), c.addRange(h), k !== document && (b = i(h.endContainer).pos(), g.scrollTo(b.x, b.y));
            g.focus();
            return this
        }, wrap: function (a) {
            var c = this.range, b;
                ...
                if (!k && a == e.start)k = !0; else if (k) {
                    ...
                    a:{
                        for (d = c; d && d.name != "body";) {
                            if (Ja[d.name] || d.name == "div" && d.hasClass("ke-script")) {
                                d = !0;
                                break a
                            }
                            d = d.parent()
                    ...
                    if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
                        for (var g; (g = c.parent()) && g.isStyle() && g.children().length == 1;)c = g;
                        g = b;
                        g = g.clone(!0);
                        if (c.type == 3)Ta(g).append(c.clone(!1)), c.replaceWith(g); else {
                            ...
                            d = Ta(h);
                            for (var j = h, n = !1; g;) {
                                for (; j;)j.name === g.name && (Nb(j, g.attr(), g.css()), n = !0), j = j.first();
            ...
            for (var b = this.range, d = b.doc, e = b.cloneRange().collapse(a), k = e.startContainer, g = e.startOffset, h = k.nodeType == 3 ? k.parentNode : k, j = !1, n; h && h.parentNode;) {
                n = i(h);
                if (c) {
                    if (!n.isStyle())break;
                    if (!Ra(n, c))break
            ...
            if (b.collapsed) {
                ...
                c = b.startContainer;
                d = b.startOffset;
                if (d > 0 && (e = i(c.childNodes[d - 1])) && oa(e))e.remove(), b.setStart(c, d - 1);
            ...
            if (d > 0) {
                ...
                m && oa(m) && (m.remove(), b.setStart(c, d - 1), c == e && b.setEnd(e,
                    o - 1));
                if ((d = i(c.childNodes[d])) && oa(d))d.remove(), c == e && b.setEnd(e, o - 1)
            }
            ...
            function c(c) {
                for (var b = c; c;) {
                    if (Ra(i(c), a))return i(c);
                    c = c.parentNode
                }
                for (; b && (b = b.lastChild);)if (Ra(i(b), a))return i(b);
                return null
            }
            ...
            if (a === "fontfamily" || a === "fontname")return b = nb(c, "fontname"), b = b.replace(/['"]/g, ""), b.toLowerCase();
            if (a === "formatblock") {
                b = nb(c, a);
            ...
            if (a === "forecolor")return(a = this.commonNode({"*": ".color"})) && (b = a.css("color")), b = q(b), b === "" && (b = "default"),
                b.toLowerCase();
            if (a === "hilitecolor")return(a = this.commonNode({"*": ".background-color"})) && (b = a.css("background-color")), b = q(b), b === "" && (b = "default"), b.toLowerCase();
            return b
        }, toggle: function (a, c) {
            ...
            fontfamily: function (a) {
                ...
                c && (e += ' target="' +
                    s(c) + '"');
                if (d.collapsed)return e += ">" + s(a) + "</a>", this.inserthtml(e);
                if (d.isControl()) {
                ...
                if (c.collapsed) {
                    ...
                    ba(a, "unlink", null);
                    ja && i(c.startContainer).name === "img" && (a = i(c.startContainer).parent(), a.name === "a" && a.remove(!0))
                } else ba(a, "unlink", null);
                return this
            }});
        h("formatblock,selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript".split(","), function (a, c) {
            ua.prototype[c] = function (a) {
                this.select();
                ba(this.doc, c, a);
                (!C || e(c, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >=
                    0) && this.selection();
                return this
            }
        });
        ...
        A(da, {init: function (a) {
            ...
            } else c.div.css("position",
                "fixed")
        }, pos: function (a, c, b) {
            b = r(b, !0);
            if (a !== null && (a = a < 0 ? 0 : j(a), this.div.css("left", a), b))this.x = a;
            if (c !== null && (c = c < 0 ? 0 : j(c), this.div.css("top", c), b))this.y = c;
            return this
        }, autoPos: function (a, c) {
            var b = o(a) || 0, d = o(c) || 0, e = ma();
            if (this._alignEl) {
                var k = i(this._alignEl), g = k.pos(), b = ca(k[0].clientWidth / 2 - b / 2), d = ca(k[0].clientHeight / 2 - d / 2);
                x = b < 0 ? g.x : g.x + b;
                y = d < 0 ? g.y : g.y + d
            } else g = X(this.doc), x = ca(e.x + (g.clientWidth - b) / 2), y = ca(e.y + (g.clientHeight - d) / 2);
        ...
        A(wa, da, {init: function (a) {
            function c() {
                ...
                if (C)b._mousedownHandler = function () {
                    ...
                    if (a.which == 8) {
                        ...
                        var c = j.range;
                        c.isControl() &&
                        (c.collapse(!0), i(c.startContainer.childNodes[c.startOffset]).remove(), a.preventDefault())
                    }
                });
                b.cmd = j;
                b.html(va(b.srcElement));
                C ? (c.body.disabled = !0, c.body.contentEditable = !0, c.body.removeAttribute("disabled")) : c.designMode = "on";
            ...
            var d = r(a.themesPath,
                ""), e = a.bodyClass, k = a.cssPath, g = a.cssData, h = location.host.replace(/:\d+/, "") !== document.domain, j = "document.open();" + (h ? 'document.domain="' + document.domain + '";' : "") + "document.close();", j = C ? ' src="javascript:void(function(){' + encodeURIComponent(j) + '}())"' : "";
            ...
            if (this.designMode) {
                b = b.body;
                if (a === d)return a = c ? "<!doctype html><html>" + b.parentNode.innerHTML + "</html>" : b.innerHTML, this.beforeGetHtml && (a = this.beforeGetHtml(a)), pa && a == "<br />" && (a = ""), a;
        ...
        A(Ea, da, {init: function (a) {
            ...
            function b(a, d) {
                var f = c(a.target);
                if (f && !f.hasClass("ke-disabled") && !f.hasClass("ke-selected"))f[d]("ke-on")
            }
        ...
        A(xa, da, {init: function (a) {
            ...
            if (a.title === "-")this.div.append(i('<div class="ke-menu-separator"></div>'));
                ...
                var c = i('<div class="ke-menu-item" unselectable="on"></div>'), b = i('<div class="ke-inline-block ke-menu-item-left"></div>'), d = i('<div class="ke-inline-block ke-menu-item-right"></div>'), e = j(a.height), k = r(a.iconClass, "");
                this.div.append(c);
                e && (c.css("height", e), d.css("line-height", e));
                var g;
                this.centerLineMode && (g = i('<div class="ke-inline-block ke-menu-item-center"></div>'), e && g.css("height", e));
                ...
                k !== "" && b.html('<span class="ke-inline-block ke-toolbar-icon ke-toolbar-icon-url ' + k + '"></span>');
                d.html(a.title);
                return this
            }
        }, remove: function () {
        ...
        i.colorpicker = vb;
        A(Za, {init: function (a) {
            var c = i(a.button), b = a.fieldName || "file", d = a.url || "", e = c.val(), k = a.extraParams || {}, g = c[0].className || "", h = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
            a.afterError = a.afterError || function (a) {
                alert(a)
            };
            var j = [], n;
            for (n in k)j.push('<input type="hidden" name="' + n + '" value="' + k[n] + '" />');
            b = ['<div class="ke-inline-block ' + g + '">', a.target ? "" : '<iframe name="' + h + '" style="display:none;"></iframe>', a.form ? '<div class="ke-upload-area">' :
                '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + h + '" action="' + d + '">', '<span class="ke-button-common">', j.join(""), '<input type="button" class="ke-button-common ke-button" value="' + e + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + b + '" tabindex="-1" />', a.form ? "</div>" : "</form>", "</div>"].join("");
            b = i(b, c.doc);
            c.hide();
            c.before(b);
            this.div = b;
            this.button = c;
            this.iframe = a.target ? i('iframe[name="' + h + '"]') : i("iframe", b);
            ...
            c.bind("load", function () {
                ...
                b.reset();
                i(b).remove(!0);
                var b = i.iframeDoc(c), d = b.getElementsByTagName("pre")[0], e = "", k, e = d ? d.innerHTML : b.body.innerHTML, e = t(e);
                c[0].src = "javascript:false";
                try {
                    k = i.json(e)
                } catch (g) {
                    a.options.afterError.call(a, "<!doctype html><html>" +
                        b.body.parentNode.innerHTML + "</html>")
                }
        ...
        A(za, da, {init: function (a) {
            var c = r(a.shadowMode, !0);
            a.z = a.z || 811213;
            a.shadowMode = !1;
            a.autoScroll = r(a.autoScroll, !0);
            za.parent.init.call(this, a);
            var b = a.title, d = i(a.body, this.doc), e = a.previewBtn, k = a.yesBtn,
                g = a.noBtn, j = a.closeBtn, n = r(a.showMask, !0);
            this.div.addClass("ke-dialog").bind("click,mousedown", function (a) {
                a.stopPropagation()
            });
            var m = i('<div class="ke-dialog-content"></div>').appendTo(this.div);
            C && O < 7 ? this.iframeMask = i('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(this.div) : c && i('<div class="ke-dialog-shadow"></div>').appendTo(this.div);
            c = i('<div class="ke-dialog-header"></div>');
            m.append(c);
            c.html(b);
            this.closeIcon = i('<span class="ke-dialog-icon-close" title="' + j.name +
                '"></span>').click(j.click);
            ...
            h([
                ...
                if (this.btn) {
                    var a = this.btn, a = a || {}, c = a.name || "", b = i('<span class="ke-button-common ke-button-outer" title="' + c + '"></span>'), c = i('<input class="ke-button-common ke-button" type="button" value="' +
                        c + '" />');
            ...
            this.height && a.height(o(this.height) - c.height() - l.height());
            this.div.width(this.div.width());
            this.div.height(this.div.height());
            this.mask = null;
            if (n)d = X(this.doc), this.mask = Wa({x: 0, y: 0, z: this.z - 1, cls: "ke-dialog-mask", width: Math.max(d.scrollWidth, d.clientWidth), height: Math.max(d.scrollHeight, d.clientHeight)});
        ...
        i.ajax = function (a, c, d, e, i) {
            var d = d || "GET", i = i || "json", g = b.XMLHttpRequest ? new b.XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
            g.open(d, a, !0);
        ...
        Aa.prototype = {lang: function (a) {
            ...
            var b = this;
            if (ia[a]) {
                if (b._calledPlugins[a])return c && c.call(b), b;
                ia[a].call(b, KindEditor);
                c && c.call(b);
                b._calledPlugins[a] = !0;
                return b
            }
            if (b.isLoading)return b;
            b.isLoading = !0;
            $a(b.pluginsPath + a + "/" + a + ".js?ver=" + encodeURIComponent(i.DEBUG ? Ga : Ha), function () {
                b.isLoading = !1;
            ...
            if (l(c))return b._handlers[a].push(c), b;
            ...
            var e = d ? X().clientWidth + "px" : c.width, g = d ? X().clientHeight + "px" : c.height;
            if (C && O < 8 || aa)g = j(o(g) + 2);
            ...
            i.each(c.items, function (a, b) {
                b == "|" ? l.push('<span class="ke-inline-block ke-separator"></span>') :
                    b == "/" ? l.push('<div class="ke-hr"></div>') : (l.push('<span class="ke-outline" data-name="' + b + '" title="' + c.lang(b) + '" unselectable="on">'), l.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + b + '" unselectable="on"></span></span>'))
            });
            var h = c.toolbar = ub({src: h, html: l.join(""), noDisableItems: c.noDisableItems, click: function (a, b) {
                a.stop();
                if (c.menu) {
                    var d = c.menu.name;
                    c.hideMenu();
                ...
                c.clickToolbar(b)
            }}), s = o(g) - h.div.height(), q = c.edit = sb({height: s > 0 && o(g) > c.minHeight ? s : c.minHeight,
                src: n, srcElement: c.srcElement, designMode: c.designMode, themesPath: c.themesPath, bodyClass: c.bodyClass, cssPath: c.cssPath, cssData: c.cssData, beforeGetHtml: function (a) {
                    ...
                    i(q.doc, document).mousedown(c._docMousedownFn);
                    Pb.call(c);
                    Qb.call(c);
                    Rb.call(c);
                    Sb.call(c);
            ...
            }, i(b).bind("resize", c._fullscreenResizeHandler), h.select("fullscreen"), m.first().css("visibility",
                "hidden"), m.last().css("visibility", "hidden")) : (pa && i(b).bind("scroll", function () {
                c._scrollPos = ma()
            }), c.resizeType > 0 ? Ua({moveEl: k, clickEl: m, moveFn: function (a, b, d, f, e, i) {
                f += i;
                c.resize(null, f)
            }}) : m.first().css("visibility", "hidden"), c.resizeType === 2 ? Ua({moveEl: k, clickEl: m.last(), moveFn: function (a, b, d, f, e, i) {
                d += e;
                f += i;
                c.resize(d, f)
            ...
            b = r(b, !0);
            if (a && (/%/.test(a) || (a = o(a), a = a < this.minWidth ? this.minWidth : a), this.container.css("width", j(a)), b))this.width = j(a);
            if (c && (c = o(c), editHeight = o(c) - this.toolbar.div.height() - this.statusbar.height(),
                editHeight = editHeight < this.minHeight ? this.minHeight : editHeight, this.edit.setHeight(editHeight), b))this.height = j(c);
            return this
        }, select: function () {
            this.isCreated && this.cmd.select();
            return this
        }, html: function (a) {
            if (a === d)return this.isCreated ? this.edit.html() : va(this.srcElement);
            ...
            var a = r(a, !0), b = this.edit, d = b.doc.body, e = bb(d.innerHTML);
            if (a && this._undoStack.length > 0 && Math.abs(e.length - ka(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize)return this;
            b.designMode && !this._firstAddBookmark ?
                (b = this.cmd.range, a = b.createBookmark(!0), a.html = bb(d.innerHTML), b.moveToBookmark(a)) : a = {html: e};
            ...
            C ? e.body.contentEditable = !a : e.designMode = a ? "off" : "on";
            ...
            a.selectedColor !== d ? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this.lang("noColor"), this.menu = vb(a)) : (a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, this.menu = Ya(a));
            return this.menu
        }, hideMenu: function () {
            this.menu.remove();
            this.menu = null;
            ...
            a.closeBtn = r(a.closeBtn, {name: b.lang("close"), click: function () {
                b.hideDialog();
                C && b.cmd && b.cmd.select()
            }});
            a.noBtn = r(a.noBtn, {name: b.lang(a.yesBtn ? "no" : "close"), click: function () {
                b.hideDialog();
                C && b.cmd && b.cmd.select()
            }});
        ...
        yb("core", function (a) {
            ...
            c.afterCreate(function () {
                if (c.syncType == "form") {
                    for (var d = a(c.srcElement), f = !1; d = d.parent();)if (d.name == "form") {
                        f = !0;
                        break
                    }
                    if (f) {
            ...
            c.clickToolbar("source", function () {
                c.edit.designMode ? (c.toolbar.disableAll(!0), c.edit.design(!1), c.toolbar.select("source")) : (c.toolbar.disableAll(!1), c.edit.design(!0), c.toolbar.unselect("source"), c.cmd.selection());
            ...
            c.clickToolbar("formatblock", function () {
                var a = c.lang("formatblock.formatBlock"), b = {h1: 28, h2: 24, h3: 18, H4: 14, p: 12}, d = c.cmd.val("formatblock"), f = c.createMenu({name: "formatblock", width: c.langType == "en" ? 200 : 150});
                h(a, function (a, e) {
                    var i = "font-size:" +
                        b[a] + "px;";
                    a.charAt(0) === "h" && (i += "font-weight:bold;");
                    f.addItem({title: '<span style="' + i + '" unselectable="on">' + e + "</span>", height: b[a] + 12, checked: d === a || d === e, click: function () {
            ...
            c.clickToolbar("fontname", function () {
                ...
                h(c.lang("fontname.fontName"), function (d, f) {
                    b.addItem({title: '<span style="font-family: ' + d + ';" unselectable="on">' + f + "</span>", checked: a === d.toLowerCase() ||
            ...
            c.clickToolbar("fontsize", function () {
                ...
                h(c.fontSizeTable, function (d, f) {
                    b.addItem({title: '<span style="font-size:' + f + ';" unselectable="on">' + f + "</span>", height: o(f) + 12, checked: a === f, click: function () {
            ...
            h("forecolor,hilitecolor".split(","), function (a, b) {
                c.clickToolbar(b, function () {
                    c.createMenu({name: b, selectedColor: c.cmd.val(b) ||
                        "default", colors: c.colorTable, click: function (a) {
                        c.exec(b, a).hideMenu()
                    }})
                })
            });
            ...
            h("link,image,flash,media,anchor".split(","), function (a, b) {
                ...
                h("edit,delete".split(","), function (a, e) {
                    c.addContextmenu({title: c.lang(e + f), click: function () {
                        c.loadPlugin(b, function () {
                            c.plugin[b][e]();
                            c.hideMenu()
                        })
                    }, cond: c.plugin["getSelected" + f], width: 150, iconClass: e == "edit" ? "ke-icon-" + b : d})
                });
            ...
            h("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function (a, b) {
                ...
                c.addContextmenu({title: c.lang("table" + b), click: function () {
                    ...
                    width: 170, iconClass: "ke-icon-table" + b})
            });
            c.addContextmenu({title: "-"});
            h("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function (a, b) {
                f[b] && c.afterCreate(function () {
                    V(this.edit.doc, f[b], function () {
                        c.cmd.selection();
                        c.clickToolbar(b)
            ...
            c.afterCreate(function () {
                function b() {
                    ...
                    var d = i[0].innerHTML;
                    i.remove();
                    d !== "" && (ja && (d = d.replace(/(<br>)\1/ig, "$1")), c.pasteType === 2 && (d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig, ""), /schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = W(d, c.filterMode ? c.htmlTags :
                ...
                a(d.body).bind("paste",
                    function (j) {
                        if (c.pasteType === 0)j.stop(); else if (!h) {
                            h = !0;
                            a("div." + g, d).remove();
                            f = c.cmd.selection();
                            e = f.range.createBookmark();
                            i = a('<div class="' + g + '"></div>', d).css({position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: a(e.start).pos().y + "px", "white-space": "nowrap"});
                            a(d.body).append(i);
                            if (C) {
                                var n = f.range.get(!0);
            ...
            c.beforeGetHtml(function (a) {
                ...
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig,function (a, b, c, d) {
                    return b + t(c).replace(/\s+/g, " ") + d
                        ...
                        var a = G(a),
                            b = Q(a.style || ""), c = fa(a["data-ke-tag"]);
            ...
            c.beforeSetHtml(function (a) {
                C && O <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/ig, function (a) {
                    var b = G(a);
                    if (Q(b.style || "").display == "none")return'<div class="ke-display-none" data-ke-input-tag="' +
                        escape(a) + '"></div>';
                    return a
                }));
                return a.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/ig,function (a) {
                    ...
                    }).replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/ig,function (a, b, c, d, f) {
                        if (a.match(/\sdata-ke-src="[^"]*"/i))return a;
                        return a = b + c + '="' + d + '" data-ke-src="' + s(d) + '"' + f
...
KindEditor.plugin("anchor", function (b) {
    ...
    d.plugin.anchor = {edit: function () {
        var l = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keName">' + g.name + "</label>", '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:100px;" /></div></div>'].join(""), l = d.createDialog({name: "anchor", width: 300, title: d.lang("anchor"), body: l, yesBtn: {name: d.lang("yes"), click: function () {
                d.insertHtml('<a name="' + e.val() + '">').hideDialog().focus()
            }}}).div,
            e = b('input[name="name"]', l);
        (l = d.plugin.getSelectedAnchor()) && e.val(unescape(l.attr("data-ke-name")));
        e[0].focus();
        e[0].select()
    }, "delete": function () {
...
KindEditor.plugin("baidumap", function (b) {
    var d = this, g = d.lang("baidumap."), l = b.undef(d.mapWidth, 558), e = b.undef(d.mapHeight, 360);
    d.clickToolbar("baidumap", function () {
        ...
        var m = ['<div style="padding:10px 20px;"><div class="ke-header"><div class="ke-left">', g.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' +
            ...
            var b = t.map, g = b.getCenter(), g = g.lng + "," + g.lat,
                b = b.getZoom(), b = [s[0].checked ? d.pluginsPath + "baidumap/index.html" : "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(g), "&zoom=" + encodeURIComponent(b), "&width=" + l, "&height=" + e, "&markers=" + encodeURIComponent(g), "&markerStyles=" + encodeURIComponent("l,A")].join("");
            s[0].checked ? d.insertHtml('<iframe src="' + b + '" frameborder="0" style="width:' + (l + 2) + "px;height:" + (e + 2) + 'px;"></iframe>') : d.exec("insertimage", b);
            d.hideDialog().focus()
        }}, beforeRemove: function () {
            o.remove();
            p && p.write("");
            q.remove()
        }}), n = m.div, j = b('[name="address"]', n), o = b('[name="searchBtn"]', n), s = b('[name="insertDynamicMap"]', m.div), t, p, q = b('<iframe class="ke-textarea" frameborder="0" src="' + d.pluginsPath + 'baidumap/map.html" style="width:' + l + "px;height:" + e + 'px;"></iframe>');
...
KindEditor.plugin("emoticons", function (b) {
    ...
    d.clickToolbar("emoticons", function () {
        ...
        function m(d, e) {
            ...
            j.cellSpacing = 0;
            j.border = 0;
            for (var n = (d - 1) * q + p, m = 0; m < s; m++)for (var o = j.insertRow(m), l = 0; l < t; l++) {
                var r = b(o.insertCell(l));
                r.addClass("ke-cell");
                h(r, l, n);
                var v = b('<span class="ke-img"></span>').css("background-position", "-" + 24 * n + "px 0px").css("background-image",
                    "url(" + g + "static.gif)");
                r.append(v);
                A.push(r);
                n++
        ...
        var s = 5, t = 9, p = 0, q = s * t, z = Math.ceil(135 / q), D = Math.floor(t / 2), r = b('<div class="ke-plugin-emoticons"></div>'),
            A = [];
        d.createMenu({name: "emoticons", beforeRemove: function () {
            n()
        }}).div.append(r);
        var w, H;
        l && (w = b('<div class="ke-preview"></div>').css("right", 0), H = b('<img class="ke-preview-img" src="' + g + p + '.gif" />'), r.append(w), w.append(H));
        var v = m(e, r), E;
        o(e)
    })
});
KindEditor.plugin("filemanager", function (b) {
    ...
    var g = this, l = b.undef(g.fileManagerJson, g.basePath + "php/file_manager_json.php"), e = g.pluginsPath + "filemanager/images/", h = g.lang("filemanager.");
    g.plugin.filemanagerDialog = function (m) {
        ...
        function j(d, e, g, h) {
            var j = b.formatUrl(e.current_url + g.filename, "absolute"), o = encodeURIComponent(e.current_dir_path + g.filename + "/");
        ...
        function o(d, e) {
            function g() {
                v.val() == "VIEW" ? n(d.current_dir_path, E.val(), t) : n(d.current_dir_path, E.val(), s)
            }
        ...
        function s(d) {
            ...
            for (var n = d.file_list, m = 0, l = n.length; m < l; m++) {
                ...
                var p = b('<img src="' + (e + (q.is_dir ? "folder-16.gif" : "file-16.gif")) + '" width="16" height="16" alt="' + q.filename + '" align="absmiddle" />'), p =
                    b(t[0].insertCell(0)).addClass("ke-cell ke-name").append(p).append(document.createTextNode(" " + q.filename));
                !q.is_dir || q.has_file ? (t.css("cursor", "pointer"), p.attr("title", q.filename), j(p, d, q, s)) : p.attr("title", h.emptyFolder);
                b(t[0].insertCell(1)).addClass("ke-cell ke-size").html(q.is_dir ? "-" : Math.ceil(q.filesize / 1024) + "KB");
                b(t[0].insertCell(2)).addClass("ke-cell ke-datetime").html(q.datetime)
            }
        }
        ...
        function t(g) {
            ...
            for (var n = g.file_list, m = 0, l = n.length; m < l; m++) {
                var s = n[m], q = b('<div class="ke-inline-block ke-item"></div>');
                w.append(q);
                ...
                q.append(p);
                var r = g.current_url + s.filename, r = b('<img src="' + (s.is_dir ? e + "folder-64.gif" : s.is_photo ? r : e + "file-64.gif") + '" width="80" height="80" alt="' + s.filename + '" />');
                !s.is_dir || s.has_file ? (p.css("cursor", "pointer"), d(p, s), j(p, g, s, t)) : p.attr("title", h.emptyFolder);
                p.append(r);
        ...
        var p = b.undef(m.width, 650), q = b.undef(m.height, 510), z = b.undef(m.dirName, ""), D = b.undef(m.viewType, "VIEW").toUpperCase(), r = m.clickFn, m = ['<div style="padding:10px 20px;"><div class="ke-plugin-filemanager-header"><div class="ke-left">', '<img class="ke-inline-block" name="moveupImg" src="' + e + 'go-up.gif" width="16" height="16" border="0" alt="" /> ', '<a class="ke-inline-block" name="moveupLink" href="javascript:;">' + h.moveup + "</a>", '</div><div class="ke-right">', h.viewType + ' <select class="ke-inline-block" name="viewType">',
            ...
            body: m}), p = A.div, w = b(".ke-plugin-filemanager-body", p);
        b('[name="moveupImg"]', p);
        var H = b('[name="moveupLink"]', p);
        b('[name="viewServer"]', p);
        var v = b('[name="viewType"]', p), E = b('[name="orderType"]', p), U = [];
        v.val(D);
        n("", E.val(), D == "VIEW" ? t : s);
        return A
    }
...
KindEditor.plugin("flash", function (b) {
    var d = this, g = d.lang("flash."), l = b.undef(d.allowFlashUpload, !0), e = b.undef(d.allowFileManager, !1), h = b.undef(d.formatUploadUrl, !0), m = b.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName, "imgFile"), j = b.undef(d.uploadJson, d.basePath + "php/upload_json.php");
    d.plugin.flash = {edit: function () {
        var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + g.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
            '<input type="button" class="ke-upload-button" value="' + g.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + g.viewServer + '" />', '</span></div><div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + g.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /> </div><div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' +
                g.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /> </div></div>'].join(""), s = d.createDialog({name: "flash", width: 450, title: d.lang("flash"), body: o, yesBtn: {name: d.lang("yes"), click: function () {
            var e = b.trim(p.val()), g = q.val(), h = z.val();
            e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), p[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {src: e, type: b.mediaType(".swf"), width: g,
                height: h, quality: "high"}), d.insertHtml(e).hideDialog().focus()) : (alert(d.lang("invalidHeight")), z[0].focus()) : (alert(d.lang("invalidWidth")), q[0].focus())
        }}}), t = s.div, p = b('[name="url"]', t), o = b('[name="viewServer"]', t), q = b('[name="width"]', t), z = b('[name="height"]', t);
        p.val("http://");
        if (l) {
            var D = b.uploadbutton({button: b(".ke-upload-button", t)[0], fieldName: n, extraParams: m, url: b.addParam(j, "dir=flash"), afterUpload: function (e) {
                s.hideLoading();
                if (e.error === 0) {
                    var g = e.url;
                    h && (g = b.formatUrl(g, "absolute"));
                    p.val(g);
                    d.afterUpload && d.afterUpload.call(d, g, e, "flash");
        ...
        e ? o.click(function () {
            d.loadPlugin("filemanager", function () {
                d.plugin.filemanagerDialog({viewType: "LIST", dirName: "flash", clickFn: function (e) {
                    d.dialogs.length > 1 && (b('[name="url"]', t).val(e), d.afterSelectFile && d.afterSelectFile.call(d,
                        e), d.hideDialog())
                }})
            })
        }) : o.hide();
...
KindEditor.plugin("image", function (b) {
    var d = this, g = b.undef(d.allowImageUpload, !0), l = b.undef(d.allowImageRemote, !0), e = b.undef(d.formatUploadUrl, !0), h = b.undef(d.allowFileManager, !1), m = b.undef(d.uploadJson, d.basePath + "php/upload_json.php"), n = b.undef(d.imageTabIndex, 0), j = d.pluginsPath + "image/images/", o = b.undef(d.extraFileUploadParams, {}), s = b.undef(d.filePostName, "imgFile"), t = b.undef(d.fillDescAfterUploadImage, !1), p = d.lang("image.");
    d.plugin.imageDialog = function (g) {
        ...
        var l = b.undef(g.showRemote, !0), r = b.undef(g.showLocal, !0), A = b.undef(g.tabIndex, 0), w = g.clickFn, H = "kindeditor_upload_iframe_" + (new Date).getTime(), v = [], E;
        for (E in o)v.push('<input type="hidden" name="' + E + '" value="' + o[E] + '" />');
        var v = ['<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' +
            ...
            h ? 450 : 400, height: r && l ? 300 : 250, title: d.lang("image"), body: v, yesBtn: {name: d.lang("yes"), click: function () {
            if (!U.isLoading)if (r && l && J && J.selectedIndex === 1 || !l)W.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (U.showLoading(d.lang("uploadLoading")), W.submit(), ea.val("")); else {
                var e = b.trim(N.val()), g = Q.val(), h = G.val(), j = Y.val(), n = "";
                M.each(function () {
                    if (this.checked)return n = this.value, !1
                });
                e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), N[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? w.call(d,
                    e, j, g, h, 0, n) : (alert(d.lang("invalidHeight")), G[0].focus()) : (alert(d.lang("invalidWidth")), Q[0].focus())
            }
        }}, beforeRemove: function () {
            V.unbind();
            Q.unbind();
        ...
        l && r ? (J = b.tabs({src: b(".tabs", F), afterSelect: function () {
        }}), J.add({title: p.remoteImage, panel: b(".tab1",
            F)}), J.add({title: p.localImage, panel: b(".tab2", F)}), J.select(A)) : l ? b(".tab1", F).show() : r && b(".tab2", F).show();
        var W = b.uploadbutton({button: b(".ke-upload-button", F)[0], fieldName: s, form: b(".ke-form", F), target: H, width: 60, afterUpload: function (g) {
            U.hideLoading();
            if (g.error === 0) {
                var h = g.url;
                e && (h = b.formatUrl(h, "absolute"));
                d.afterUpload && d.afterUpload.call(d, h, g, "image");
                t ? (b(".ke-dialog-row #remoteUrl", F).val(h), b(".ke-tabs-li", F)[0].click(), b(".ke-refresh-btn", F).click()) : w.call(d, h, g.title, g.width, g.height,
                    g.border, g.align)
        ...
        h ? V.click(function () {
            d.loadPlugin("filemanager", function () {
                d.plugin.filemanagerDialog({viewType: "VIEW", dirName: "image", clickFn: function (e) {
                    d.dialogs.length > 1 && (b('[name="url"]', F).val(e), d.afterSelectFile && d.afterSelectFile.call(d, e), d.hideDialog())
                }})
            })
        }) : V.hide();
        var T = 0, fa = 0;
        S.click(function () {
            var d = b('<img src="' + N.val() + '" />', document).css({position: "absolute",
    ...
    d.plugin.image = {edit: function () {
        ...
        d.plugin.imageDialog({imageUrl: b ? b.attr("data-ke-src") : "http://", imageWidth: b ? b.width() : "", imageHeight: b ? b.height() : "", imageTitle: b ? b.attr("title") : "", imageAlign: b ? b.attr("align") : "", showRemote: l, showLocal: g, tabIndex: b ? 0 : n, clickFn: function (b, e, g, h, j, n) {
            d.exec("insertimage", b, e, g, h, j, n);
            setTimeout(function () {
                d.hideDialog().focus()
            }, 0)
        }})
...
KindEditor.plugin("insertfile", function (b) {
    var d = this, g = b.undef(d.allowFileUpload, !0), l = b.undef(d.allowFileManager, !1), e = b.undef(d.formatUploadUrl, !0), h = b.undef(d.uploadJson, d.basePath + "php/upload_json.php"), m = b.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName, "imgFile"), j = d.lang("insertfile.");
    d.plugin.fileDialog = function (o) {
        var s = b.undef(o.fileUrl, "http://"), t = b.undef(o.fileTitle, ""), p = o.clickFn, o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + j.url +
            ...
            q = d.createDialog({name: "insertfile", width: 450, title: d.lang("insertfile"), body: o, yesBtn: {name: d.lang("yes"), click: function () {
                var e = b.trim(D.val()), g = r.val();
                e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")), D[0].focus()) : (b.trim(g) === "" && (g = e), p.call(d, e, g))
            }}}), z = q.div, D = b('[name="url"]', z), o = b('[name="viewServer"]', z), r = b('[name="title"]', z);
        if (g) {
            var A = b.uploadbutton({button: b(".ke-upload-button", z)[0], fieldName: n, url: b.addParam(h, "dir=file"), extraParams: m, afterUpload: function (g) {
                q.hideLoading();
                if (g.error === 0) {
                    var h = g.url;
                    e && (h = b.formatUrl(h, "absolute"));
                    D.val(h);
                    d.afterUpload && d.afterUpload.call(d, h, g, "insertfile");
                    alert(d.lang("uploadSuccess"))
                } else alert(g.message)
            }, afterError: function (b) {
                q.hideLoading();
    ...
    d.clickToolbar("lineheight", function () {
        ...
        b.each(g.lineHeight, function (e, g) {
            b.each(g, function (b, e) {
                h.addItem({title: e, checked: l === b, click: function () {
...
KindEditor.plugin("link", function (b) {
    ...
    d.plugin.link = {edit: function () {
        var g = d.lang("link."), l = '<div style="padding:20px;"><div class="ke-dialog-row"><label for="keUrl" style="width:60px;">' + g.url + '</label><input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:260px;" /></div><div class="ke-dialog-row""><label for="keType" style="width:60px;">' + g.linkType + '</label><select id="keType" name="type"></select></div></div>', l = d.createDialog({name: "link", width: 450, title: d.lang("link"),
            body: l, yesBtn: {name: d.lang("yes"), click: function () {
                var g = b.trim(e.val());
                g == "http://" || b.invalidUrl(g) ? (alert(d.lang("invalidUrl")), e[0].focus()) : d.exec("createlink", g, h.val()).hideDialog().focus()
            }}}).div, e = b('input[name="url"]', l), h = b('select[name="type"]', l);
        e.val("http://");
        h[0].options[0] = new Option(g.newWindow, "_blank");
        h[0].options[1] = new Option(g.selfWindow, "");
        d.cmd.selection();
        if (g = d.plugin.getSelectedLink())d.cmd.range.selectNode(g[0]), d.cmd.select(), e.val(g.attr("data-ke-src")), h.val(g.attr("target"));
        e[0].focus();
        e[0].select()
    }, "delete": function () {
        d.exec("unlink", null)
...
KindEditor.plugin("map", function (b) {
    ...
    d.clickToolbar("map", function () {
        ...
        var e = ['<div style="padding:10px 20px;"><div class="ke-dialog-row">', g.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:200px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + g.search + '" />', '</span></div><div class="ke-map" style="width:558px;height:360px;"></div></div>'].join(""),
            e = d.createDialog({name: "map", width: 600, title: d.lang("map"), body: e, yesBtn: {name: d.lang("yes"), click: function () {
                var b = n.map, e = b.getCenter().lat() + "," + b.getCenter().lng(), g = b.getZoom(), b = b.getMapTypeId(), h = "http://maps.googleapis.com/maps/api/staticmap";
                ...
                beforeRemove: function () {
                    ...
                    j && j.write("");
                    o.remove()
                }}).div, h = b('[name="address"]', e), m = b('[name="searchBtn"]', e), n, j;
        ...
        var o = b('<iframe class="ke-textarea" frameborder="0" src="' + d.pluginsPath + 'map/map.html" style="width:558px;height:360px;"></iframe>');
...
KindEditor.plugin("media", function (b) {
    var d = this, g = d.lang("media."), l = b.undef(d.allowMediaUpload, !0), e = b.undef(d.allowFileManager, !1), h = b.undef(d.formatUploadUrl, !0), m = b.undef(d.extraFileUploadParams, {}), n = b.undef(d.filePostName, "imgFile"), j = b.undef(d.uploadJson, d.basePath + "php/upload_json.php");
    d.plugin.media = {edit: function () {
        var o = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + g.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;',
            ...
            e == "http://" || b.invalidUrl(e) ?
                (alert(d.lang("invalidUrl")), p[0].focus()) : /^\d*$/.test(g) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {src: e, type: b.mediaType(e), width: g, height: h, autostart: D[0].checked ? "true" : "false", loop: "true"}), d.insertHtml(e).hideDialog().focus()) : (alert(d.lang("invalidHeight")), z[0].focus()) : (alert(d.lang("invalidWidth")), q[0].focus())
        }}}), t = s.div, p = b('[name="url"]', t), o = b('[name="viewServer"]', t), q = b('[name="width"]', t), z = b('[name="height"]', t), D = b('[name="autostart"]', t);
        p.val("http://");
        if (l) {
            var r = b.uploadbutton({button: b(".ke-upload-button", t)[0], fieldName: n, extraParams: m, url: b.addParam(j, "dir=media"), afterUpload: function (e) {
                s.hideLoading();
                if (e.error === 0) {
                    var g = e.url;
                    h && (g = b.formatUrl(g, "absolute"));
                    p.val(g);
                    d.afterUpload && d.afterUpload.call(d, g, e, "media");
                    alert(d.lang("uploadSuccess"))
                } else alert(e.message)
            }, afterError: function (b) {
                s.hideLoading();
        ...
        e ? o.click(function () {
            d.loadPlugin("filemanager", function () {
                d.plugin.filemanagerDialog({viewType: "LIST", dirName: "media", clickFn: function (e) {
                    d.dialogs.length > 1 && (b('[name="url"]', t).val(e), d.afterSelectFile && d.afterSelectFile.call(d, e), d.hideDialog())
                }})
            })
        }) : o.hide();
    ...
    b.extend(d, {init: function (d) {
        ...
        var h = {debug: !1, upload_url: d.uploadUrl, flash_url: d.flashUrl, file_post_name: d.filePostName, button_placeholder: b(".ke-swfupload-button > input", e.div)[0], button_image_url: d.buttonImageUrl, button_width: d.buttonWidth, button_height: d.buttonHeight,
            button_cursor: SWFUpload.CURSOR.HAND, file_types: d.fileTypes, file_types_description: d.fileTypesDesc, file_upload_limit: d.fileUploadLimit, file_size_limit: d.fileSizeLimit, post_params: d.postParams, file_queued_handler: function (b) {
                ...
                (d = b('div[data-id="' + d.id + '"]', e.bodyDiv).eq(0), l(d, e.options.errorMessage))
            }, upload_success_handler: function (d, g) {
                var h = b('div[data-id="' + d.id + '"]', e.bodyDiv).eq(0), o = {};
                try {
                    o = b.json(g)
                } catch (s) {
                    e.options.afterError.call(this, "<!doctype html><html>" + g + "</html>")
                }
                o.error !== 0 ? l(h, b.DEBUG ? o.message : e.options.errorMessage) : (d.url = o.url, b(".ke-img", h).attr("src", d.url).attr("data-status", d.filestatus).data("data", o), b(".ke-status > div", h).hide())
            }};
        ...
        b(".ke-img", self.bodyDiv).each(function () {
            var l = b(this);
            l.attr("data-status") == SWFUpload.FILE_STATUS.COMPLETE && d.push(l.data("data"))
        });
        return d
        ...
        b('<div class="ke-message">' + l.options.pendingMessage + "</div>").appendTo(m);
        e.append('<div class="ke-name">' + d.name + "</div>");
        l.progressbars[d.id] = {bar: b(".ke-progressbar-bar-inner", h), percent: b(".ke-progressbar-percent", h)}
    }, remove: function () {
        this.removeFiles();
        this.swfu.destroy();
        this.div.html("")
...
KindEditor.plugin("multiimage", function (b) {
    ...
    var g = b.undef(d.uploadJson, d.basePath + "php/upload_json.php"), l = d.pluginsPath + "multiimage/images/", e = b.undef(d.imageSizeLimit, "1MB");
    ...
    d.plugin.multiImageDialog = function (j) {
        var o = j.clickFn, j = b.tmpl(n.uploadDesc, {uploadLimit: h, sizeLimit: e}), s = d.createDialog({name: "multiimage", width: 650,
            height: 510, title: d.lang("multiimage"), body: '<div style="padding:20px;"><div class="swfupload"></div></div>', previewBtn: {name: n.insertAll, click: function () {
                ...
                (!b.IE || b.V <= 8) && t.remove()
            }}), t = b.swfupload({container: b(".swfupload", s.div), buttonImageUrl: l + (d.langType == "zh_CN" ? "select-files-zh_CN.png" : "select-files-en.png"), buttonWidth: d.langType == "zh_CN" ? 72 : 88, buttonHeight: 23, fileIconUrl: l + "image.png",
...
(function () {
    if (!window.SWFUpload)window.SWFUpload = function (b) {
        ...
        if (typeof b === "object")for (var g in b)b.hasOwnProperty(g) && d.push(encodeURIComponent(g.toString()) + "=" + encodeURIComponent(b[g].toString()));
        return d.join("&amp;")
        ...
        try {
            e = g.CallFunction('<invoke name="' + b + '" returntype="javascript">' + __flash__argumentsToXML(d, 0) + "</invoke>"), l = eval(e)
        } catch (h) {
        ...
        if (g != void 0)g.style.width = b + "px", g.style.height = d + "px";
        ...
        if (b != void 0) {
            for (var e in b.post)if (b.post.hasOwnProperty(e)) {
                l = e;
                for (var h; (h = d.exec(l)) !== null;)l = l.replace(h[0], String.fromCharCode(parseInt("0x" + h[1], 16)));
                g[l] = b.post[e]
            }
            b.post = g
        }
        ...
        if (this.settings.debug) {
            ...
            if (typeof b === "object" && typeof b.name === "string" && typeof b.message === "string") {
                for (var g in b)b.hasOwnProperty(g) && d.push(g + ": " + b[g]);
                b = d.join("\n") || "";
                d = b.split("\n");
                b = "EXCEPTION: " + d.join("\nEXCEPTION: ")
            }
        ...
        try {
            ...
            if (!d)g = document.createElement("form"),
                document.getElementsByTagName("body")[0].appendChild(g), d = document.createElement("textarea"), d.id = "SWFUpload_Console", d.style.fontFamily = "monospace", d.setAttribute("wrap", "off"), d.wrap = "off", d.style.overflow = "auto", d.style.width = "700px", d.style.height = "350px", d.style.margin = "5px", g.appendChild(d);
            d.value += b + "\n";
...
KindEditor.plugin("pagebreak", function (b) {
    var d = this, g = b.undef(d.pagebreakHtml, '<hr style="page-break-after: always;" class="ke-pagebreak" />');
    d.clickToolbar("pagebreak", function () {
        var l = d.cmd, e = l.range;
        d.focus();
        e.enlarge(!0);
        l.split(!0);
        var h = d.newlineTag == "br" || b.WEBKIT ? "" : '<p id="__kindeditor_tail_tag__"></p>';
        d.insertHtml(g + h);
        h !== "" && (h = b("#__kindeditor_tail_tag__", d.edit.doc), e.selectNodeContents(h[0]), h.removeAttr("id"), l.select())
    })
});
KindEditor.plugin("plainpaste", function (b) {
    var d = this;
    d.clickToolbar("plainpaste", function () {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("plainpaste.").comment + '</div><textarea class="ke-textarea" style="width:408px;height:260px;"></textarea></div>', g = d.createDialog({name: "plainpaste", width: 450, title: d.lang("plainpaste"), body: g, yesBtn: {name: d.lang("yes"), click: function () {
            var e = l.val(), e = b.escape(e), e = e.replace(/ {2}/g, " &nbsp;"), e = d.newlineTag == "p" ? e.replace(/^/,
                "<p>").replace(/$/, "</p>").replace(/\n/g, "</p><p>") : e.replace(/\n/g, "<br />$&");
...
KindEditor.plugin("preview", function (b) {
    ...
    d.clickToolbar("preview", function () {
        d.lang("preview.");
        var g = d.createDialog({name: "preview", width: 750, title: d.lang("preview"), body: '<div style="padding:10px 20px;"><iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe></div>'}), g = b("iframe", g.div), l = b.iframeDoc(g);
        l.open();
        l.write(d.fullHtml());
        l.close();
...
KindEditor.plugin("quickformat", function (b) {
    ...
    g.clickToolbar("quickformat", function () {
        g.focus();
        for (var e = g.edit.doc, h = g.cmd.range, m = b(e.body).first(), n, j = [], o = [], s = h.createBookmark(!0); m;) {
            n = m.next();
            var t = d(m);
            if (!t || t.name != "img")if (l[m.name] ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/ig, "")), m.css("text-indent", "2em")) : o.push(m), !n || l[n.name] || l[m.name] && !l[n.name])o.length >
                0 && j.push(o), o = [];
            m = n
        }
...
KindEditor.plugin("table", function (b) {
    ...
    function g(g, h) {
        ...
        h.click(function () {
            o();
            var h = b(this), j = h.pos(), j = b.colorpicker({x: j.x, y: j.y + h.height(), z: 811214, selectedColor: b(this).html(), colors: e.colorTable,
    ...
    e.plugin.table = {prop: function (n) {
        var j = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keRows" style="width:90px;">' + h.cells + "</label>", h.rows + ' <input type="text" id="keRows" class="ke-input-text ke-input-number" name="rows" value="" maxlength="4" /> &nbsp; ',
                ...
                var d = o.val(), g = l.val(), h = m.val(), j = p.val(), n = q.val(), E = z.val(), G = D.val(), S = r.val(), Y = A.val(),
                    M = w.val(), J = b(H[0]).html() || "", W = b(H[1]).html() || "";
                if (d == 0 || !/^\d+$/.test(d))alert(e.lang("invalidRows")), o[0].focus(); else if (g == 0 || !/^\d+$/.test(g))alert(e.lang("invalidRows")), l[0].focus(); else if (/^\d*$/.test(h))if (/^\d*$/.test(j))if (/^\d*$/.test(G))if (/^\d*$/.test(S))if (/^\d*$/.test(M))if (v)h !== "" ? v.width(h + n) : v.css("width", ""), v[0].width !== void 0 && v.removeAttr("width"), j !== "" ? v.height(j + E) : v.css("height", ""), v[0].height !== void 0 && v.removeAttr("height"), v.css("background-color", W), v[0].bgColor !== void 0 && v.removeAttr("bgColor"), G !== "" ? v[0].cellPadding = G : v.removeAttr("cellPadding"), S !== "" ? v[0].cellSpacing = S : v.removeAttr("cellSpacing"), Y !== "" ? v[0].align = Y : v.removeAttr("align"), M !== "" ? v.attr("border", M) : v.removeAttr("border"), M === "" || M === "0" ? v.addClass("ke-zeroborder") : v.removeClass("ke-zeroborder"), J !== "" ? v.attr("borderColor", J) : v.removeAttr("borderColor"), e.hideDialog().focus(); else {
                    var T = "";
                    h !== "" && (T += "width:" + h + n + ";");
                    j !== "" && (T += "height:" + j + E + ";");
                    ...
                    e.addBookmark()
                } else alert(e.lang("invalidBorder")), w[0].focus();
                else alert(e.lang("invalidSpacing")), r[0].focus(); else alert(e.lang("invalidPadding")), D[0].focus(); else alert(e.lang("invalidHeight")), p[0].focus(); else alert(e.lang("invalidWidth")), m[0].focus()
            }}}).div, o = b('[name="rows"]', j).val(3), l = b('[name="cols"]', j).val(2), m = b('[name="width"]', j).val(100), p = b('[name="height"]', j), q = b('[name="widthType"]', j), z = b('[name="heightType"]', j), D = b('[name="padding"]', j).val(2), r = b('[name="spacing"]', j).val(0), A = b('[name="align"]', j), w = b('[name="border"]', j).val(1),
        ...
        if (!n && (v = e.plugin.getSelectedTable())) {
            ...
            o.attr("disabled", !0);
            l.attr("disabled", !0);
            var E, n = v[0].style.width || v[0].width, j = v[0].style.height || v[0].height;
            n !== void 0 && (E = /^(\d+)((?:px|%)*)$/.exec(n)) ? (m.val(E[1]), q.val(E[2])) : m.val("");
            if (j !== void 0 && (E = /^(\d+)((?:px|%)*)$/.exec(j)))p.val(E[1]), z.val(E[2]);
            D.val(v[0].cellPadding || "");
            r.val(v[0].cellSpacing || "");
            A.val(v[0].align || "");
            w.val(v[0].border === void 0 ? "" : v[0].border);
            d(H.eq(0), b.toHex(v.attr("borderColor") || ""));
            d(H.eq(1), b.toHex(v[0].style.backgroundColor || v[0].bgColor || ""));
            m[0].focus();
            m[0].select()
        }
    }, cellprop: function () {
        var n = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + h.size + "</label>", h.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ',
            ...
            n = e.createDialog({name: "table", width: 500, title: e.lang("tablecell"), body: n, beforeRemove: function () {
                ...
                var d = j.val(), g = o.val(), h = l.val(), n = m.val();
                p.val();
                q.val();
                var H = z.val(), ea = D.val(), V = r.val(), Q = b(A[0]).html() || "", G = b(A[1]).html() || "";
                /^\d*$/.test(d) ? /^\d*$/.test(g) ? /^\d*$/.test(V) ? (w.css({width: d !== "" ? d + h : "", height: g !== "" ? g + n : "", "background-color": G, "text-align": H, "vertical-align": ea, "border-width": V, "border-style": V !== "" ? "solid" : "", "border-color": Q}),
                    e.hideDialog().focus(), e.addBookmark()) : (alert(e.lang("invalidBorder")), r[0].focus()) : (alert(e.lang("invalidHeight")), o[0].focus()) : (alert(e.lang("invalidWidth")), j[0].focus())
            }}}).div, j = b('[name="width"]', n).val(100), o = b('[name="height"]', n), l = b('[name="widthType"]', n), m = b('[name="heightType"]', n), p = b('[name="padding"]', n).val(2), q = b('[name="spacing"]', n).val(0), z = b('[name="textAlign"]', n), D = b('[name="verticalAlign"]', n), r = b('[name="border"]', n).val(1), A = b(".ke-input-color", n);
        g(n, A.eq(0));
        g(n, A.eq(1));
        d(A.eq(0), "#000000");
        d(A.eq(1), "");
        j[0].focus();
        j[0].select();
        var w = e.plugin.getSelectedCell(), H = w[0].style.height || w[0].height || "";
        (n = /^(\d+)((?:px|%)*)$/.exec(w[0].style.width || w[0].width || "")) ? (j.val(n[1]), l.val(n[2])) : j.val("");
        if (n = /^(\d+)((?:px|%)*)$/.exec(H))o.val(n[1]), m.val(n[2]);
        ...
        var g = e.plugin.getSelectedTable()[0], h = e.plugin.getSelectedRow()[0], m = e.plugin.getSelectedCell()[0], d = m.cellIndex + d;
        ...
        var g = e.plugin.getSelectedTable()[0], h = e.plugin.getSelectedRow()[0], l = e.plugin.getSelectedCell()[0], m = h.rowIndex;
        d === 1 && (m = h.rowIndex + (l.rowSpan - 1) + d);
        for (var p = g.insertRow(m), q = 0, z = h.cells.length; q < z; q++) {
            h.cells[q].rowSpan > 1 && (z -= h.cells[q].rowSpan - 1);
            var D = p.insertCell(q);
            if (d === 1 && h.cells[q].colSpan > 1)D.colSpan = h.cells[q].colSpan;
            D.innerHTML = b.IE ? "" : "<br />"
        }
        for (h =
                 m; h >= 0; h--)if (d = g.rows[h].cells, d.length > q) {
            for (g = l.cellIndex; g >= 0; g--)d[g].rowSpan > 1 && (d[g].rowSpan += 1);
            break
        }
        ...
        var b = e.plugin.getSelectedTable()[0], d = e.plugin.getSelectedRow()[0], g = e.plugin.getSelectedCell()[0], h = d.rowIndex + g.rowSpan, d = b.rows[h];
        if (!(b.rows.length <= h))b = g.cellIndex, d.cells.length <= b || (h = d.cells[b],
            g.colSpan === h.colSpan && (g.rowSpan += h.rowSpan, d.deleteCell(b), e.cmd.range.selectNodeContents(g).collapse(!0), e.cmd.select(), e.addBookmark()))
    }, colmerge: function () {
        e.plugin.getSelectedTable();
        var b = e.plugin.getSelectedRow()[0], d = e.plugin.getSelectedCell()[0], g = d.cellIndex + 1;
        if (!(b.cells.length <= g)) {
            var h = b.cells[g];
            d.rowSpan === h.rowSpan && (d.colSpan += h.colSpan, b.deleteCell(g), e.cmd.range.selectNodeContents(d).collapse(!0), e.cmd.select(), e.addBookmark())
        }
    }, rowsplit: function () {
        var d = e.plugin.getSelectedTable()[0],
            g = e.plugin.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0], m = g.rowIndex;
        if (h.rowSpan !== 1) {
        ...
        e.plugin.getSelectedTable();
        var d = e.plugin.getSelectedRow()[0], g = e.plugin.getSelectedCell()[0], h = g.cellIndex;
        if (g.colSpan !== 1) {
            for (var l =
                1, m = g.colSpan; l < m; l++) {
        ...
        for (var d = e.plugin.getSelectedTable()[0], g = e.plugin.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0].cellIndex, l = 0, m = d.rows.length; l < m; l++) {
            var p = d.rows[l], q = p.cells[h];
            q.colSpan > 1 ? (q.colSpan -= 1, q.colSpan === 1 && b(q).removeAttr("colSpan")) : p.deleteCell(h);
            q.rowSpan >
                1 && (l += q.rowSpan - 1)
        }
        g.cells.length === 0 ? (e.cmd.range.setStartBefore(d).collapse(!0), e.cmd.select(), b(d).remove()) : e.cmd.selection(!0);
        e.addBookmark()
    }, rowdelete: function () {
        for (var d = e.plugin.getSelectedTable()[0], g = e.plugin.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0], g = g.rowIndex, h = h.rowSpan - 1; h >= 0; h--)d.deleteRow(g + h);
...
KindEditor.plugin("template", function (b) {
    function d(d) {
        return l + d + "?ver=" + encodeURIComponent(b.DEBUG ? b.TIME : b.VERSION)
    }
    ...
    g.clickToolbar("template", function () {
        var e = g.lang("template."), h = ['<div style="padding:10px 20px;">', '<div class="ke-header">', '<div class="ke-left">', e.selectTemplate + " <select>"];
        ...
        var e = g.createDialog({name: "template", width: 500, title: g.lang("template"), body: html, yesBtn: {name: g.lang("yes"), click: function () {
                var d = b.iframeDoc(j);
                g[n[0].checked ? "html" : "insertHtml"](d.body.innerHTML).hideDialog().focus()
            }}}),
            l = b("select", e.div), n = b('[name="replaceFlag"]', e.div), j = b("iframe", e.div);
        n[0].checked = !0;
        j.attr("src", d(l.val()));
        l.change(function () {
...
KindEditor.plugin("wordpaste", function (b) {
    ...
    d.clickToolbar("wordpaste", function () {
        var g = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + d.lang("wordpaste.").comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:408px;height:260px;"></iframe></div>', g = d.createDialog({name: "wordpaste", width: 450, title: d.lang("wordpaste"), body: g, yesBtn: {name: d.lang("yes"), click: function () {
            var e = l.body.innerHTML, e = b.clearMsWord(e, d.filterMode ? d.htmlTags : b.options.htmlTags);
            d.insertHtml(e).hideDialog().focus()
